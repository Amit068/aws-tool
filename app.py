...
# ── Shared chart constants (defined OUTSIDE column blocks) ──
AWS_COLORS = [
    '#FF9900','#1A7FBF','#2DB57D','#E6522C','#8B5CF6',
...
DARK_LAYOUT = dict(
    ...
    legend=dict(bgcolor='rgba(0,0,0,0)', font=dict(color='#0D2B4E')),
)
...
with chart_col2:
    ...
    fig_bar = px.bar(
        ...
        color_continuous_scale=[[0,'#90CAF9'],[0.5,'#1976D2'],[1,'#FF9900']],
        text='Total Cost (USD)',
    )
    ...
    fig_bar.update_layout(
        ...
        plot_bgcolor='rgba(0,0,0,0)',
        font=dict(color='#0D2B4E', family='Arial'),
        yaxis=dict(autorange="reversed", color='#1565C0', gridcolor='#BBDEFB'),
        xaxis=dict(color='#1565C0', gridcolor='#BBDEFB'),
...
if len(all_rows) > 1:
    ...
    with acct_col1:
        ...
        fig_acct.update_layout(
            ...
            coloraxis_showscale=False,
            xaxis=dict(tickangle=-35, color='#1565C0', gridcolor='#BBDEFB'),
            yaxis=dict(color='#1565C0', gridcolor='#BBDEFB'),
